 ...
 */
public class ImugiColdModel extends EntityModel<ImugiColdEntity> {
    ...
    @Override
    public void setRotationAngles(ImugiColdEntity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {}
